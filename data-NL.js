function setNL()
{
    ...
    Factions = {
        ...
        TR: {Image: "images\\factions\\cards\\small\\TR.jpg", Deck: "C2", Name: "Trollen", Include: false, Phase_ab:2, Ability: "Je kunt elke beurt maximaal 1 Trol winnen. Andere Trollen blijven liggen voor de volgende ronde."},        
        //CR: MAP                                      ,
        ...
        UN: {Image: "images\\factions\\cards\\small\\UN.jpg", Deck: "CRMAP", Name: "Eenhoorns", Include: false, Phase_ab:2, Ability: "Alle Eenhoorns die je gewonnen hebt geven +1 waarde aan alle andere te spelen kaarten. De bonus geldt niet voor de Eenhoorn factie. De bonus telt ook niet bij het bepalen van de meerderheid aan het einde van het spel."},        
        //CR: MER                                        ,
        ...
        OR: {Image: "images\\factions\\cards\\small\\OR.jpg", Deck: "CRMER", Name: "Orchi", Include: false, Phase_ab:3, Ability: "Geen speciale kracht."},        
        //CR: MAG                                        ,
        ...
        MI: {Image: "images\\factions\\cards\\small\\MI.jpg", Deck: "PROMO", Name: "Minotaurs", Include: false, Phase_ab:2, Ability: "Als je de Leider van een slag bent en wint met een Minotaur, dan mag de andere speler zijn gespeelde kaart terug op hand nemen."},        
        TI: {Image: "images\\factions\\cards\\small\\TI.png", Deck: "PROMO", Name: "Tinkerers", Include: false, Phase_ab:2, Ability: "Als een Tinkerer een slag wint met waarde 4 of meer, explodeert de kaart! Leg de tinkerer af. Je wint nog steeds de slag en de andere kaart."},
        VL: {Image: "images\\factions\\cards\\small\\VL.png", Deck: "PROMO", Name: "Valkyrie", Include: false, Phase_ab:3, Ability: "Als de Valkyrie een andere factie volgt, wordt de Valkyrie die factie als de waarde van de gespeelde Valkyrie 3 of hoger is dan de eerst gespeelde kaart."},
        //CR: FEA                                        ,
        ...
        //CR: SKY                                        ,
        AN: {Image: "images\\factions\\cards\\small\\AN.jpg", Deck: "CRSKY", Name: "Engelen", Include: false, Phase_ab:3, Ability: "Als je aan het einde van het spel geen andere kaarten in je score-stapel hebt met hetzelfde getal als jouw Engel, dan telt die Engel x2 voor de meerderheid van de factie."},
        EA: {Image: "images\\factions\\cards\\small\\EA.jpg", Deck: "CRSKY", Name: "Adelaars", Include: false, Phase_ab:3, Ability: "Een Adelaar kan niet 2 keer achter elkaar een slag leiden. (Uitzondering: de Leider heeft alleen Adelaars.)"},
        PT: {Image: "images\\factions\\cards\\small\\PT.jpg", Deck: "CRSKY", Name: "Pterosauriërs", Include: false, Phase_ab:3, Ability: "Aan het einde van het spel sterft elke Pterosauriër met een waarde van 7 of hoger uit! De kaarten tellen niet mee voor de meerderheid van de factie."},
        LE: {Image: "images\\factions\\cards\\small\\LE.jpg", Deck: "CRSKY", Name: "Bliksem Elementen", Include: false, Phase_ab:2, Ability: "In Fase 2 mag je een willekeurig aantal Bliksem Elementen van je score-stapel afleggen om een gespeelde kaart te verhogen. Met elke afgelegde kaart verhoog je de waarde van de gespeelde kaart met +1."},
        VK: {Image: "images\\factions\\cards\\small\\VK.jpg", Deck: "CRSKY", Name: "Vulturekin", Include: false, Phase_ab:3, Ability: "Als je aan het einde van het spel de meerderheid van de Vulturekin hebt, schud je de aflegstapel van Fase 1 en pak je gedekt 2 kaarten. Voeg de kaarten toe aan je score-stapel."},
        //CR: SEA                                        ,
        PI: {Image: "images\\factions\\cards\\small\\PI.png", Deck: "CRSEA", Name: "Piraten", Include: false, Phase_ab:3, Ability: "Als een speler aan het einde van het spel een Piraat en een Koninklijke Marine van dezelfde waarde heeft, dan wordt de Piraat gearresteerd. De kaart telt nu als een koninklijke marinekaart bij het bepalen van de meerderheid van de factie. De kaart telt niet als een Piraat."},
        RN: {Image: "images\\factions\\cards\\small\\RN.png", Deck: "CRSEA", Name: "Koninklijke Marine", Include: false, Phase_ab:3, Ability: "Als een speler aan het einde van het spel een Piraat en een Koninklijke Marine van dezelfde waarde heeft, wordt de piraat gearresteerd en telt nu als een kaart van de factie van de Koninklijke Marine."},
        SM: {Image: "images\\factions\\cards\\small\\SM.png", Deck: "CRSEA", Name: "Zeemonsters", Include: false, Phase_ab:1, Ability: "Als in Fase 1 een zeemonster wordt onthuld, dan moeten de spelers één kaart uit hun hand ruilen. Wissel de kaart gedekt en neem de nieuwe kaart op hand."},
        OC: {Image: "images\\factions\\cards\\small\\OC.jpg", Deck: "CRSEA", Name: "Octopussen", Include: false, Phase_ab:3, Ability: "Elke factiekaart met een waarde van 8 of hoger van een andere factie wint automatisch van een Octopus."},
        FP: {Image: "images\\factions\\cards\\small\\FP.jpg", Deck: "CRSEA", Name: "Vismensen", Include: false, Phase_ab:3, Ability: "Als je een slag verliest en je hebt een Vismens gespeeld, dan neem je een drietandkaart van de trekstapel of van een andere speler als alle drietandkaarten van de trekstapel al zijn genomen. De waarde van alle Vismenskaarten wordt verhoogd met 1 voor elke drietandkaart die je bezit."},
        //CR: SUN                                        ,
        SUN_MONKS: {Image: "images\\factions\\cards\\small\\SUN_MONKS.jpg", Deck: "CRSUN", Name: "Zon Monniken", Include: false, Phase_ab:3, Ability: "Wanneer een Zon Monnik wordt gespeeld, moet deze worden gevolgd door een Ster Monnik om de factie te volgen. Als de factie correct wordt gevolgd, wint de hoogste kaart. Als een een Zon Monnik wordt gevolgd door een andere Zon Monnik, dan wordt dit beschouwd als het niet volgen van de factie. Je verliest dan automatisch de slag."},
        STAR_MONKS: {Image: "images\\factions\\cards\\small\\STAR_MONKS.jpg", Deck: "CRSUN", Name: "Ster Monniken", Include: false, Phase_ab:3, Ability: "Wanneer een Ster Monnik wordt gespeeld, moet deze worden gevolgd door een Zon Monnik om de factie te volgen. Als de factie correct wordt gevolgd, wint de hoogste kaart. Als een een Ster Monnik wordt gevolgd door een andere Ster Monnik, dan wordt dit beschouwd als het niet volgen van de factie. Je verliest dan automatisch de slag. "},
        PR: {Image: "images\\factions\\cards\\small\\PR.jpg", Deck: "CRSUN", Name: "Profeten", Include: false, Phase_ab:2, Ability: "In Fase 2 wordt aan de hand van het aantal runen bepaald wie de winnaar van de Profeten is. Als de spelers samen minstens 3 runen in de score-stapel hebben, dan wint de Profeet met de hoogste waarde. Als de spelers samen minder dan 3 runen in de score-stapel hebben, dan wint de Profeet met de laagste waarde. Runen staan als iconen op de profeetkaarten."},
        SW: {Image: "images\\factions\\cards\\small\\SW.jpg", Deck: "CRSUN", Name: "Zandwormen", Include: false, Phase_ab:3, Ability: "In Fase 1 en 2 een slag wordt gestart met een Zandworm, worden de kaarten in deze slag gedekt gespeeld. De kaarten worden onthuld als alle kaarten gespeeld zijn."},
        SC: {Image: "images\\factions\\cards\\small\\SC.jpg", Deck: "CRSUN", Name: "Schorpioenen", Include: false, Phase_ab:2, Ability: "Als je in Fase 2 een schorpioen aan je score-stapel toevoegt, moet je een stekel van de trekstapel pakken. De stekel geeft je in de volgende slag strafpunten of een zeldzame bonus. Daarna wordt de stekel afgelegd. Als de stapel met stekelkaarten op raakt, schud je de afgelegde kaarten en vorm je een nieuwe trekstapel."},
        //C: 5 ann edition
        AU: {Image: "images\\factions\\cards\\small\\AU.jpg", Deck: "C5A", Name: "Automaten", Include: false, Phase_ab:1, Ability: "[MT] De winnaar van de slag wint automatisch ook de volgende slag en is de leider van de daaropvolgende slag."},
        BD: {Image: "images\\factions\\cards\\small\\BD.jpg", Deck: "C5A", Name: "Barden", Include: false, Phase_ab:3, Ability: "[MT] Aan het einde van het spel wint de speler met de langste opeenvolgende reeks Barden de stem van de factie."},
        GR: {Image: "images\\factions\\cards\\small\\GR.jpg", Deck: "C5A", Name: "Griffioenen", Include: false, Phase_ab:2, Ability: "[MT] Gewonnen Griffioenen geven in een volgende slag +5 kracht als je een kaart met dezelfde waarde speelt."},
        PE: {Image: "images\\factions\\cards\\small\\PE.jpg", Deck: "C5A", Name: "Boer", Include: false, Phase_ab:3, Ability: "[MT] Aan het einde van het spel verlaat een Boer je koninkrijk als je geen Koninklijke hebt met dezelfde waarde tot +3."},
        RA: {Image: "images\\factions\\cards\\small\\RA.jpg", Deck: "C5A", Name: "Wasberen", Include: false, Phase_ab:3, Ability: "[MT] Wasberen met een buit-symbool tellen aan het einde van het spel ook mee voor de factie waarvan je de minste kaarten hebt."},
        RO: {Image: "images\\factions\\cards\\small\\RO.jpg", Deck: "C5A", Name: "Koninklijken", Include: false, Phase_ab:3, Ability: "[MT] Aan het einde van het spel verlaat een Boer je koninkrijk als je geen Koninklijke hebt met dezelfde waarde tot +3."},
        VI: {Image: "images\\factions\\cards\\small\\VI.jpg", Deck: "C5A", Name: "Vikingen", Include: false, Phase_ab:3, Ability: "[MT] Aan het einde van het spel telt elke Viking voor 2 als er een andere kaart met dezelfde waarde in je puntenset ligt."},
    };
    ...
    Strings = {
        ...
        PT_RULE: "Portugees spelregels door Sansão Oliveira*",
