function setES()
{
    ...
    Factions = {
        ...
        DE: {Image: "images\\factions\\cards\\small\\DE.jpg", Deck: "PROMO", Name: "Dark Elves", Include: false, Phase_ab:2, Ability: "Si en una baza consigues al menos un Elfo Oscuro para tu pila de Simpatizantes, debes retirar de la partida una carta de alguna otra facción de tu pila de Simpatizantes. Si solo tienes Elfos Oscuros en tu pila de Simpatizantes, no tienes que descartar ninguna. Si en una baza consigues más de un Elfo Oscuro, aun así solo retiras una carta de otra facción."},
        GH: {Image: "images\\factions\\cards\\small\\GH.jpg", Deck: "PROMO", Name: "Ghosts", Include: false, Phase_ab:1, Ability: "Puedes quedarte con la carta de Fantasma que has jugado, en vez de la carta que te correspondería. Si decides hacerlo, retira de la partida la carta que te correspondería y coloca la carta de Fantasma en tu pila de Seguidores. Si te correspondería robar la carta superior del mazo, retírala sin mirarla."},
        ME: {Image: "images\\factions\\cards\\small\\ME.jpg", Deck: "PROMO", Name: "Mermaids", Include: false, Phase_ab:3, Ability: "Cuando consigas Sirenas para tu pila de Simpatizantes, colócalas boca arriba. Por cada Sirena que tengas, las cartas que juegues tendrán valor -1. "},
